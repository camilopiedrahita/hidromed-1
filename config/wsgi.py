...
os.environ['DJANGO_ALLOWED_HOSTS'] = '206.191.155.173'
os.environ['DJANGO_ADMIN_URL'] = '206.191.155.173/admin'
...
os.environ['DATABASE_URL'] = 'mysql://hidromeddb:wf569KZp5m@localhost/hidromed'
