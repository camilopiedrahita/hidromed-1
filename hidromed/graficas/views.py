...
from hidromed.medidores.models import Medidor_Acueducto
from hidromed.medidores.models import Medidor_Cliente
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                messages.error(request,
                               'No ha diligenciado todos los ' +
                               ' campos del formulario')

        # formato fecha
        if tipo_de_filtro == '7' and desde is not None and hasta is not None:
